...
object RequestAirdropUseCase {
    ...
    suspend operator fun invoke(
        ...
        return withContext(Dispatchers.IO) {
            ...
            Base58DecodeUseCase(signatureBase58)
        }
    }

    private fun createRequestAirdropRequest(publicKey: ByteArray, commitment: Commitment): String {
        val jo = JSONObject()
        jo.put("jsonrpc", "2.0")
        jo.put("id", 1)
